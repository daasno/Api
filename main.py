...
if uploaded_file:
    ...
    new_geek.drop(
        ['05', '0,7ohms', '0,25ohms', '1,4ohms', 'Pods', 'Orange', 'Rose', 'Vert', 'Rainbow', 'Bleu', 'Scarlet-Rouge', '0,4ohms',
         'Gold', '04', 'Grey-Gris fonce', 'Violet-Neon-Chestnut-Sky M', '0,6ohms', '065', '03', 'Chrome', 'None',
         'Noir'], inplace=True,axis=1)
